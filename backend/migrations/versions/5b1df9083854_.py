...
def upgrade():
    ...
    sa.Column('valor_max', sa.Integer(), nullable=True),
    sa.Column('valor_min', sa.Integer(), nullable=True),
    ...
    sa.Column('cantidad_actual_m3', sa.Integer(), nullable=False),
    ...
    sa.Column('cantidad_actual_kg', sa.Integer(), nullable=True),
    sa.Column('cantidad_actual_m3', sa.Integer(), nullable=True),
