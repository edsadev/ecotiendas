...
class Login extends React.Component{
  ...
  login = async () => {
    // this.props.dispatch(setUser('0928066398', 'milann', 'masculino', 'esala.094@gmail.com', '0994234166', new Date(), 'ecoamigo', '0', 'Edmundo', 'Salamanca', '10000', null))
    ...
    return (
      <SafeAreaView style={styles.container}>
        ...
        <View style={styles.formulario}>
          ...
          <TouchableOpacity style={[styles.boton, {backgroundColor: BLANCO}]} onPress={() => this.props.navigation.navigate('Registro')}>
