...
class NewRegional extends React.Component {
  ...
  check = (e) => {
    e.preventDefault()
    console.log(this.cedula.value, this.nombre.value, this.apellido.value, this.direccion.value, this.genero.value, this.correo.value, this.celular.value, this.fecha.value, this.userPhoto, this.state.photo64)
  }
          ...
          <SubContainer>
            <Form>
              <Izq>
                ...
                <h3 className="title_green"><GoBackArrow classTo="arrow" history={this.props.history}/>Registrar EcoZonal</h3>
              ...
              <Der>
                <div id="sub">
                  ...
                  <label className="btn-form">
                    <input ref={(input) => this.userPhoto = input} type="file" name="userPhoto" alt="Foto Perfil" onChange={(e) => this.handleChange(e)}/>
